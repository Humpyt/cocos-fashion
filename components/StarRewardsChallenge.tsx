...
const StarRewardsChallenge: React.FC = () => {
  const categories = [
    { name: 'Fragrances', img: 'https://picsum.photos/seed/sr1/400/400' },
    { name: 'Jewelry & Watches', img: 'https://picsum.photos/seed/sr2/400/400' },
    { name: 'Women\'s Shoes', img: 'https://picsum.photos/seed/sr3/400/400' },
    { name: 'Handbags', img: 'https://picsum.photos/seed/sr4/400/400' },
    { name: 'Sleep & Intimates', img: 'https://picsum.photos/seed/sr5/400/400' },
  ];
        ...
        <div className="max-w-[1400px] mx-auto px-4">
            <div className="bg-[#f5f5f5] p-12 flex flex-col md:flex-row gap-12 items-center">
                <div className="md:w-1/3 flex flex-col items-center text-center">
                    <div className="bg-macys-red text-white p-8 mb-6 relative">
                    ...
                    <h4 className="text-2xl font-black mb-4">Shop <span className="text-macys-red">2 of these 5</span> categories<br/>& get $10 in Star Money</h4>
                ...
                <div className="md:w-2/3 grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="col-span-2 row-span-2 relative group cursor-pointer overflow-hidden bg-macys-red flex flex-col justify-center items-center text-white text-center p-8">
