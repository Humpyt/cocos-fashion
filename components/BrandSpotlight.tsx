...
const BrandSpotlight: React.FC = () => {
  const brands = [
    { name: 'Lancôme', desc: 'Rénergie H.P.N. 300-Peptide Cream', img: 'https://images.unsplash.com/photo-1590156221122-c748c78f2a43?auto=format&fit=crop&q=80&w=600' },
    { name: 'Anolon', desc: 'Tri-Ply Stainless Steel Collection', img: 'https://images.unsplash.com/photo-1584990344468-5abc651f57ce?auto=format&fit=crop&q=80&w=600' },
    { name: 'Sports Shop', desc: 'Sportswear for everyone.', img: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&q=80&w=600' },
  ];

  return (
    <section className="max-w-[1400px] mx-auto px-4 py-12 md:py-24">
        <div className="flex flex-col lg:flex-row gap-6 md:gap-12 mb-12">
            ...
            <div className="w-full lg:w-2/3 h-[300px] md:h-auto">
                 <img src="https://images.unsplash.com/photo-1490114538077-0a7f8cb49891?auto=format&fit=crop&q=80&w=1200" className="w-full h-full object-cover" alt="Main Arrival" />
            </div>
        </div>
