...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-black text-white border-t border-gray-800 mt-12 md:mt-24">
        ...
        <div className="max-w-[1400px] mx-auto px-4 py-10 md:py-16 grid grid-cols-1 lg:grid-cols-3 gap-12 border-b border-gray-800">
        ...
        {/* Legal & Bottom Nav */}
        <div className="max-w-[1400px] mx-auto px-4 py-10 md:py-8 text-center">
